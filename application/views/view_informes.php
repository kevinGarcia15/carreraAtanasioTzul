...
if (isset($categoria)) {
$rama = $categoria; //es la variable que seleccionaria el usaurio como categoria 
}
			...
			<form action="<?=$base_url?>/informes/categoria"  method="POST">
				<td><strong>Seleccione la categoría</strong></td>
					<select  class="form-control" name="selectCategoria">
						<option value="Todos" <?php if($rama=="Todos"){echo "selected";}  ?>>Todos</option>
						<option value="Libre" <?php  if($rama=="Libre"){echo "selected";} ?>>Libre</option>
						<option value="Femenina" <?php if($rama=="Femenina"){echo "selected";} ?>>Femenina</option>
						<option value="Master Masculina" <?php if($rama=="Master Masculina"){echo "selected";} ?>>Master Masculina</option>
					</select>
    </div>
