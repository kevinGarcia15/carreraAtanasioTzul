...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2019 at 12:35 AM
...
--
-- Database: `bd_carrera_atanasio_tzul`
--
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `no_atletas` ()  SELECT count(*) as atletas FROM corredor$$
...
INSERT INTO `corredor` (`id_corredor`, `Nombre`, `Fecha_nacimiento`, `CUI`, `Email`, `Telefono`, `Rama`, `Fecha_inscripcion`, `Usuario_id_usuario`, `municipio_id_municipio`) VALUES
(1, 'Kevin Tomás García', '1995-08-09', 2750050030801, 'gkevin964@gmail.com', '57469663', 'Master Masculina', '2019-06-27 15:47:46', 3, 2),
(2, 'Walter Pretzantzín', '1993-07-13', 2244757800801, 'internautaporsiempre@gmail.com', '47162720', 'Master Masculina', '2019-06-27 19:02:00', 3, 42),
(3, 'Hedy Melisa Tacam', '1994-06-28', 2734569981235, 'heidy@hotmail.com', '45301581', 'Femenina', '2019-06-28 06:17:39', 3, 329),
(4, '', '0000-00-00', 0, '', '', 'Libre', '2019-07-01 21:16:35', 3, 137),
(5, 'Carlos García Pérez', '1999-07-15', 1111111111111, 'ejemplo@example.com', '45827845', 'Libre', '2019-07-09 18:24:38', 4, 2),
(6, 'Josué Caniz Pérez', '1990-04-05', 2255457820801, 'example@hotmail.com', '77660001', 'Libre', '2019-07-10 20:13:52', 4, 26),
(7, '', '0000-00-00', 10, '', '', 'Libre', '2019-07-10 20:21:56', 4, 151),
(8, 'rolando guillermo amezquita caniz', '1984-03-19', 1799706250801, '', '77663456', 'Libre', '2019-07-21 08:46:06', 11, 2),
(9, 'MARINA DEL ROSARIO PEREZ JUAREZ', '1975-03-19', 176838790567, 'RO@hotmali.com', '45678902', 'Femenina', '2019-07-21 08:50:35', 11, 90),
(10, 'German Samuel', '1965-04-23', 3236482369889, 'glopezpiv@hotmail.com', '77664000', 'Libre', '2019-08-07 20:29:47', 4, 2);
...
INSERT INTO `familiar` (`id_familiar`, `Nombre`, `Telefono`, `Corredor_id_corredor`) VALUES
(1, 'Juana Castro', '77662444', 1),
(2, 'Mily Pérez', '55604060', 2),
(3, 'Juan Hernández', '35250821', 3),
(4, '', '', 4),
(5, 'Karla Matea Pérez Tzoc', '77660001', 5),
(6, 'Carlos Tacam', '77660002', 6),
(7, '', '', 7),
(8, 'juan amezquita', '45678903', 8),
(9, 'maria ambrosia', '45678903', 9),
(10, 'Rebeca Perez', '55608907', 10);
...
INSERT INTO `inscripcion` (`id_inscripcion`, `numero_atleta`, `fecha_participacion`, `corredor_id_corredor`) VALUES
(1, 1, 2019, 1),
(2, 104, 2019, 2),
(3, 10, 2019, 3),
(4, 0, 2019, 4),
...
(6, 'Walter Pretzantzín', 'jere1', '2222222222222', 47162720, 'internautaporsiempre@gmail.com', '705a5636f4639f9940e288b4ff9c8fe398d0d74af5ff849e78b34d3401e86034', 131215, 'A', 'Administrador'),
(7, 'Omar Arrega', 'OmarArrega', '1456987456123', 56916685, 'Arregaomar@gmail.com', '512982cba01c0cf55f06e5c9604bb3cc066eff4577ed1792869ce7e9b1cf67ee', 762561, 'A', 'Administrador'),
(8, 'Derick Emanuel Vasquez Lopez', 'monkito', '2264781650801', 31782145, 'k3k3r3k3@gmail.com', 'e5d6ea5ab89cfbf1f749986a596b4bf492a6be16ef68de7c7eef7313b17402ca', 150923, 'A', 'Administrador'),
(9, 'abigail Morales', 'abita', '7894561230801', 48876084, 'k3k3r3k3@gmail.com', 'dc5648671b4187fcdccc542439228bdfb86d9498532ef9d0c658c850f446ce01', 886839, 'A', 'Administrador'),
(10, 'emmanuel', 'emmanuel', '786510801', 31782145, 'drickvasquez@hotmail.com', '1e8c37b1525866c24736ba7b5d06198e7589f6dafa12636bab9769eb90676156', 642666, 'A', 'Digitador'),
(11, 'Digitador 1', 'Digitador 1', '8090754280801', 77660012, 'ejemplo.12@hotmail.com', '128276f6706341ff13d9ae1016bc15cd29fffa90d7450f67636b9545841fd47d', 57983, 'A', 'Digitador');
